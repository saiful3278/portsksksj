...
summary: "Magic Portfolio's styling uses data-attributes customization."
...
Magic Portfolio's styling uses data-attributes. You can generate a custom color palette for brand, accent and neutral colors and apply it to your site.
